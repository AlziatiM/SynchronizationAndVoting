...
NMI_cluster_gt_relabelAndVote = readmatrix(strcat("../../", path,"/GaussianSynth/Clusters/NMI_cluster_gt_relabelAndVote_GaussianSynth.txt"));
NMI_cluster_gt_weightedVoting_simple = readmatrix(strcat("../../", path,"/GaussianSynth/Clusters/NMI_cluster_gt_weightedVoting_simple_GaussianSynth.txt"));
NMI_cluster_gt_weightedVoting_average = readmatrix(strcat("../../", path,"/GaussianSynth/Clusters/NMI_cluster_gt_weightedVoting_average_GaussianSynth.txt"));

% NMI_cluster_gt_relabelAndVote = readmatrix("../../Results/GaussianSynth/Clusters/NMI_cluster_gt_relabelAndVote_GaussianSynth.txt");
% NMI_cluster_gt_weightedVoting_simple = readmatrix("../../Results/GaussianSynth/Clusters/NMI_cluster_gt_weightedVoting_simple_GaussianSynth.txt");
% NMI_cluster_gt_weightedVoting_average = readmatrix("../../Results/GaussianSynth/Clusters/NMI_cluster_gt_weightedVoting_average_GaussianSynth.txt");
% 
...
% 
% 
% NMI_partition_relabelAndVote = readmatrix("../../Results/GaussianSynth/Partitions/NMI_partition_relabelAndVote_GaussianSynth.txt");
% NMI_partition_weightedVoting_simple = readmatrix("../../Results/GaussianSynth/Partitions/NMI_partition_weightedVoting_simple_GaussianSynth.txt");
% NMI_partition_weightedVoting_average = readmatrix("../../Results/GaussianSynth/Partitions/NMI_partition_weightedVoting_average_GaussianSynth.txt");
% 
...
if(size(NMI_partition_gt_relabelAndVote, 1) > 7)
    variableK = false;
end
