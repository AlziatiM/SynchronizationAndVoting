...
figure
plot( x_K,NMI_noise(1,:), x_K, NMI_noise(2,:),x_K, NMI_noise(3,:),x_K, NMI_noise(4,:), x_K, NMI_noise(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average NMI with different # of clusters")
xlabel("# of Clusters")
ylabel("NMI")
hold off
...
plot( x_K,ARI_noise(1,:), x_K, ARI_noise(2,:),x_K,ARI_noise(3,:),x_K, ARI_noise(4,:), x_K, ARI_noise(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average ARI with different # of clusters")
xlabel("# of Clusters")
ylabel("ARI")
hold off
...
figure
plot( x_K,NMI_noise_gt(1,:), x_K, NMI_noise_gt(2,:),x_K, NMI_noise_gt(3,:),x_K, NMI_noise_gt(4,:), x_K, NMI_noise_gt(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average NMI wrt the GT with different # of clusters")
xlabel("# of Clusters")
ylabel("NMI")
hold off
...
plot( x_K,ARI_noise_gt(1,:), x_K, ARI_noise_gt(2,:),x_K,ARI_noise_gt(3,:),x_K, ARI_noise_gt(4,:), x_K, ARI_noise_gt(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average ARI wrt the GT with different # of clusters")
xlabel("# of Clusters")
ylabel("ARI")
hold off
