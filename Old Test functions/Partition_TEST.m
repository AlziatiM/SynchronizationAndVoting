...
figure
plot( x_M,NMI_noise(1,:), x_M, NMI_noise(2,:),x_M, NMI_noise(3,:),x_M, NMI_noise(4,:), x_M, NMI_noise(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average NMI with different n°  of partitions")
...
plot( x_M,ARI_noise(1,:), x_M, ARI_noise(2,:),x_M,ARI_noise(3,:),x_M, ARI_noise(4,:), x_M, ARI_noise(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average ARI with different n°  of partitions")
xlabel("# of Partitions")
ylabel("ARI")
hold off
...
figure
plot( x_M,NMI_noise_gt(1,:), x_M, NMI_noise_gt(2,:),x_M, NMI_noise_gt(3,:),x_M, NMI_noise_gt(4,:), x_M, NMI_noise_gt(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average NMI wrt the GT with different n°  of partitions")
xlabel("# of Partitions")
ylabel("NMI")
hold off
...
plot( x_M,ARI_noise_gt(1,:), x_M, ARI_noise_gt(2,:),x_M,ARI_noise_gt(3,:),x_M, ARI_noise_gt(4,:), x_M, ARI_noise_gt(5,:));
hold on
l = legend("Hungarian", "Regression", "Matchpairs","Jonker-Volgenant",    "Mcla");
l.Location = "northwest";

title("Average ARI wrt the GT with different n°  of partitions")
xlabel("# of Partitions")
ylabel("ARI")
hold off
