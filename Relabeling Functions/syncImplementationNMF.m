function [T_out, U] = syncImplementationNMF(PI,PI_LM, perc, simpleSync, trueK)
M = size(PI,1);
...
[T_out, U] = nmfSync(T_mat, nc, trueK);
if(size(full(U),2)~= trueK)
    sas = 1;
end


U = mat2cell(full(U),nc);
